...
class LottoMatchTest {
	...
	void testShouldReturnSecondClassCompareLottoNumber() {
		...
		lottoMatch.lotto.lottoNumber = new int[] {1,2,3,4,5,7};
		lottoMatch.lotto.bonusNumber = 10;
		
		Lotto tempLotto = new Lotto();
		tempLotto.lottoNumber = new int[] {1,2,3,4,5,6};
		tempLotto.bonusNumber = 10;
		assertEquals(new String("2등"), lottoMatch.matchClassLottoNumber(tempLotto));
	}
}
